...
#         # ---- Raw (per-frame) attentive reading, then debounce it so a
#         # single stray frame doesn't flip the displayed status/box color.
#         # See the note above GAZE_RATIO_LEFT/RIGHT for why this changed. ----
#         raw_looking_at_screen = (direction == "Center") and (gaze == "Center")
